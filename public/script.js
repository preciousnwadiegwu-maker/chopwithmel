...
const MENU = [
  ...
  { id: 39, category: 'Rice & Pasta', name: 'Jollof Rice (2L)',              description: 'Party-style smoky jollof — the real deal.',                     price: 40000,  emoji: '🍛', image: IMG('1664993101841-036f189719b6') },
  { id: 40, category: 'Rice & Pasta', name: 'Jollof Rice (4L)',              description: 'Party-style smoky jollof — the real deal.',                     price: 80000,  emoji: '🍛', image: IMG('1664993101841-036f189719b6') },
  ...
  { id: 45, category: 'Rice & Pasta', name: 'Asun Jollof Rice (2L)',         description: 'Jollof rice topped with peppered goat meat (asun).',           price: 40000,  emoji: '🍖', image: IMG('1564464392342-54692a5d59a0') },
  { id: 46, category: 'Rice & Pasta', name: 'Asun Jollof Rice (4L)',         description: 'Jollof rice topped with peppered goat meat (asun).',           price: 80000,  emoji: '🍖', image: IMG('1564464392342-54692a5d59a0') },
  { id: 47, category: 'Rice & Pasta', name: 'Fried Rice (2L)',               description: 'Golden fried rice with mixed veggies and seasoning.',           price: 40000,  emoji: '🍳', image: IMG('1512058564366-18510be2db19') },
  { id: 48, category: 'Rice & Pasta', name: 'Fried Rice (4L)',               description: 'Golden fried rice with mixed veggies and seasoning.',           price: 80000,  emoji: '🍳', image: IMG('1512058564366-18510be2db19') },
  { id: 49, category: 'Rice & Pasta', name: 'Creamy Penny Pasta (2L)',       description: 'Penne pasta in a rich, creamy sauce.',                          price: 50000,  emoji: '🍝', image: IMG('1611270629569-8b357cb88da9') },
  { id: 50, category: 'Rice & Pasta', name: 'Creamy Penny Pasta (4L)',       description: 'Penne pasta in a rich, creamy sauce.',                          price: 110000, emoji: '🍝', image: IMG('1611270629569-8b357cb88da9') },
  { id: 51, category: 'Rice & Pasta', name: 'Jollof Penny Pasta (2L)',       description: 'Penne pasta cooked Nigerian jollof-style.',                     price: 40000,  emoji: '🍝', image: IMG('1473093295043-cdd812d0e601') },
  { id: 52, category: 'Rice & Pasta', name: 'Jollof Penny Pasta (4L)',       description: 'Penne pasta cooked Nigerian jollof-style.',                     price: 80000,  emoji: '🍝', image: IMG('1473093295043-cdd812d0e601') },
  { id: 53, category: 'Rice & Pasta', name: 'Alfredo Linguine Pasta (2L)',   description: 'Linguine in a velvety Alfredo cream sauce.',                    price: 50000,  emoji: '🍜', image: IMG('1611270629569-8b357cb88da9') },
  { id: 54, category: 'Rice & Pasta', name: 'Alfredo Linguine Pasta (4L)',   description: 'Linguine in a velvety Alfredo cream sauce.',                    price: 110000, emoji: '🍜', image: IMG('1611270629569-8b357cb88da9') },
  { id: 55, category: 'Rice & Pasta', name: 'Stir Fry Pasta (2L)',           description: 'Pasta tossed in a spicy, flavourful stir-fry sauce.',           price: 40000,  emoji: '🥡', image: IMG('1564464392342-54692a5d59a0') },
  { id: 56, category: 'Rice & Pasta', name: 'Stir Fry Pasta (4L)',           description: 'Pasta tossed in a spicy, flavourful stir-fry sauce.',           price: 80000,  emoji: '🥡', image: IMG('1564464392342-54692a5d59a0') },
